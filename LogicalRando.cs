...
{
    /**
     * NOTE TO SELF: This is just copied from ConnectionRandomizer.LogicalRando, with a few minor modifications.
     * Make changes in ConnectionRandomizer, then copy them over here.
     */
            ...
            public float EstimateNewConnectionScore(string thisConn, string skipName, List<Connectible> otherConnectibles)
            {
                ...
                foreach (Connectible c in otherConnectibles)
                {
                    ...
                    foreach (string thatConn in c.connections.Keys)
                    {
                        ...
                        float score = this.ConnectionScore(c, thisConn, thatConn);
